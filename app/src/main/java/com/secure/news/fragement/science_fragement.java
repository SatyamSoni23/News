...
public class science_fragement extends Fragment implements NewsItemClicked {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.science_fragement, null);
    ...
    private void fetch_data(){
        String url = "https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=f25bd7cf2bf341fa8db0f6f426364335";
