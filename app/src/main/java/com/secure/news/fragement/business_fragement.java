...
public class business_fragement extends Fragment implements NewsItemClicked {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.business_fragement, null);

        recyclerView = v.findViewById(R.id.business_recylerView);
        fetch_data();
