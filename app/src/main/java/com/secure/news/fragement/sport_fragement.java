...
public class sport_fragement extends Fragment implements NewsItemClicked {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.sport_fragement, null);

        recyclerView = v.findViewById(R.id.sport_recyclerView);
        fetch_data();
    ...
    private void fetch_data(){
        String url = "https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=f25bd7cf2bf341fa8db0f6f426364335";
